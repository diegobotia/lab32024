...
public class FlightController {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(code=403, message = "El acceso al recurso qyue usted intenta alcanzar es prohibido"),
            @ApiResponse(code=404, message = "El acceso al recurso qyue usted intenta alcanzar no se encuentra")
    }    )
    @GetMapping("/listAll")
